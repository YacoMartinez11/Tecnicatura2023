# Ejercicio 11: Agrna telefonica
# Hacer un programa que simule una agenda de constactos. Crear un diccionario donde la clave sea el nombre
# del usuario y el valor sea el telefono, el programa tendrá el siguiente menú
# de opciones:
#             1. Nuevo contacto
#             2. Borrar contacto
...
while True:
    ...
    if opcion == 1:
        ...
        telefono = input('Digite eñ número de teléfono: ')
